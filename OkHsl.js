...
const l = 0.9; // Lightness

// Call the function and print the response
console.log(rgb_to_hex(...okhsl_to_srgb(204,0.3229,0.991))=="#fefcfc");
...
// #
// #
console.log(rgb_to_hex(...okhsl_to_srgb(322,0.5654,0.0326))=="#0a0204");
console.log(rgb_to_hex(...okhsl_to_srgb(154,0.4242,0.2898))=="#603342");
console.log(rgb_to_hex(...okhsl_to_srgb(14,0.3855,0.8406))=="#e8c8d1");
console.log(rgb_to_hex(...okhsl_to_srgb(86,0.3241,0.5420))=="#a47180");
console.log(rgb_to_hex(...okhsl_to_srgb(187,0.4981,0.2164))=="#4d2231");
console.log(rgb_to_hex(...okhsl_to_srgb(88,0.5883,0.3099))=="#722d46");
console.log(rgb_to_hex(...okhsl_to_srgb(189,0.6557,0.7653))=="#efa5bb");
console.log(rgb_to_hex(...okhsl_to_srgb(334,0.4031,0.7575))=="#dcacb9");
console.log(rgb_to_hex(...okhsl_to_srgb(20,0.0413,0.7901))=="#c7c2c4");
console.log(okhsl_to_srgb(189,0.70,0.70));